...
export default function PopupEdit() {
    ...
    function handleClick(event) {
        ...
        setInput({
            activity: '', dificulty: '', season: '', duration: '',
        })
        console.log("si");
    };
    ...
    return (
        <div className="forms">
            ...
            <div className="countries-activities">
            ...
            <div className="form-popup" hidden={show}>
                <form className="form-container">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Enter Activity" name="activity" onChange={handleInputChange} value={input.activity} />
                        <output className="danger">{errors.activity}</output>
                    </div>
                    <div>
                        <label className="label" htmlFor="dificulty"><b>Dificulty</b></label>
                        <input type="text" placeholder="Enter Dificulty" name="dificulty" onChange={handleInputChange} value={input.dificulty} />
                        <output className="danger">{errors.dificulty}</output>
                    </div>
                    <div>
                        <label className="label" htmlFor="season"><b>Season</b></label>
                        <input type="text" placeholder="Enter Season" name="season" onChange={handleInputChange} value={input.season} />
                        <output className="danger">{errors.season}</output>
                    </div>
                    <div>
                        <label className="label" htmlFor="duration"><b>Duration</b></label>
                        <input type="text" placeholder="Enter Duration" name="duration" onChange={handleInputChange} value={input.duration} />
